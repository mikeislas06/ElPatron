        ...
        <div style={{ width: "100%" }}>
          ...
          >
            ...
            >
              ...
              <p>
                Estamos para servirle en la ciudad de Puebla, Sonata, Zona de
        ...
        <div style={{ width: "100%" }}>
          ...
          >
            ...
            >
              <h4>Experiencia</h4>
              <p>
                Toda una experiencia culinaria, con nuestro sistema rotativo de
                mas de 16 cortes en espada al carbón llevados a su mesa,
                acompañados de amplia barra de ensaladas y postres.
              </p>
            </div>
          </ReactCardFlip>
        </div>
